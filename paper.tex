...
In contrast, the SANS policy says what security features are required and that, whilst secured access points are preferred, an open access point may be used with a VPN.
